...
def main_peak():
    ...
    res_dic_arr = []
    inspection_range = 15  # 一回に15行分を取得して検討する
        ...
        if len(d) >= inspection_range:
            ...
            if ans_42["ans"] == 0:
                ...
                res_dic = {
                    ...
                    "return_ratio": ans_42['info']['return_ratio'],
    ...
    f.draw_graph(mid_df)
    print(entry_count, tp_count, lc_count, mid_df.iloc[0]["time_jp"])
